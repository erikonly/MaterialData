export default {
  ...
  materialDetail: {
    ...
    composition: 'Composition',
    alloyDesignation: 'Alloy Designation',
    ...
    microscopeReferences: 'Microscope References',
    tensileProperties: 'Tensile Properties',
    yieldStrength: 'Yield Strength',
    tensileStrength: 'Tensile Strength',
    elongation: 'Elongation',
    ...
    stressStrainData: 'Stress-Strain Data',
    curveReference: 'Curve Reference',
